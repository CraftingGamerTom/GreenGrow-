...
public class AdvDryTableGUI extends GuiContainer{
	private IInventory playerInv;
	private ADTTileEntity te;
	public final ResourceLocation texture = new ResourceLocation(RefStrings.MODID, "textures/gui/adtgui.png"); //Create/rename location and file

public AdvDryTableGUI(InventoryPlayer inventory, ADTTileEntity drytable) {
	super(new ContainerAdvDryTable(inventory, drytable)); //create container
