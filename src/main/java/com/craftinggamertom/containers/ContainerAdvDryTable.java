...
import com.craftinggamertom.slots.ADTDryingSlot;
...
public class ContainerAdvDryTable extends Container{

	private ADTTileEntity te;

	private int timeDrying;
	private int blockLight;
		
		public ContainerAdvDryTable(InventoryPlayer playerInventory, ADTTileEntity te)
		{
			this.te = te;
	        ...
	        this.addSlotToContainer(new ADTDryingSlot(te, 1, 30 + 0 * 18, 17 + 0 * 18));
	        this.addSlotToContainer(new ADTDryingSlot(te, 2, 30 + 1 * 18, 17 + 0 * 18));
	        this.addSlotToContainer(new ADTDryingSlot(te, 3, 30 + 2 * 18, 17 + 0 * 18));
	        this.addSlotToContainer(new ADTDryingSlot(te, 4, 30 + 0 * 18, 17 + 1 * 18));
	        this.addSlotToContainer(new ADTDryingSlot(te, 5, 30 + 1 * 18, 17 + 1 * 18));
	        this.addSlotToContainer(new ADTDryingSlot(te, 6, 30 + 2 * 18, 17 + 1 * 18));
	        this.addSlotToContainer(new ADTDryingSlot(te, 7, 30 + 0 * 18, 17 + 2 * 18));
	        this.addSlotToContainer(new ADTDryingSlot(te, 8, 30 + 1 * 18, 17 + 2 * 18));
	        this.addSlotToContainer(new ADTDryingSlot(te, 9, 30 + 2 * 18, 17 + 2 * 18));
