...
public class AdvancedDryBench extends Block implements ITileEntityProvider {
	public AdvancedDryBench(){
		super(Material.wood);
		this.setBlockTextureName("advdrybench");
        this.setCreativeTab(MCreativeTabs.greengrow);
		this.setHardness(5.0F);
		this.setResistance(5.0F);
		this.setStepSound(soundTypeStone);
		// This was a parameter before but is just false by default now to have no parameters when creating a bench.
        this.isOn = false;
	}
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(RefStrings.MODID + ":adt_side");
        this.field_149936_O = p_149651_1_.registerIcon(this.isOn ? RefStrings.MODID + ":adt_front_on" : RefStrings.MODID + ":adt_front_off");
        this.field_149935_N = p_149651_1_.registerIcon(RefStrings.MODID + ":adt_top");
    }
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata) {
		...
		if (!keepInventory) 
		{
			ADTTileEntity tileentity = (ADTTileEntity) world.getTileEntity(x, y, z);
	...
	public void onBlockPlacedBy(World world, int xCord, int yCord, int zCord, EntityLivingBase placer, ItemStack stack) {
		...
		if (stack.hasDisplayName()) {
	        ((ADTTileEntity) world.getTileEntity(xCord, yCord, zCord)).setCustomName(stack.getDisplayName());
	    }
	...
	public boolean onBlockActivated(World world, int xCord, int yCord, int zCord, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
		if (!world.isRemote) {
	        ...
	        ADTTileEntity tileentity = (ADTTileEntity)world.getTileEntity(xCord, yCord, zCord);
	    ...
	    FMLNetworkHandler.openGui(player, "greengrow", GUIHandler.ADT_TILE_ENTITY, world, xCord, yCord, zCord); //DT_TILE_ENTITY represents '2'
	    return true;
	}
     ...
     */
    public static void updateDTBlockState(boolean isOn, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        int l = p_149931_1_.getBlockMetadata(p_149931_2_, p_149931_3_, p_149931_4_);
        TileEntity tileentity = (TileEntity) p_149931_1_.getTileEntity(p_149931_2_, p_149931_3_, p_149931_4_);
        field_149934_M = true;
        
        if (isOn)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.DryBenchOn);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.DryBench);
        }
    ...
    {
    	ADTTileEntity pbt = new ADTTileEntity();
