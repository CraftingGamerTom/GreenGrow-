...
public class DryBench extends Block implements ITileEntityProvider {
	public DryBench(Boolean isOn){
		super(Material.wood);
		this.setBlockTextureName("drybench");
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(RefStrings.MODID + ":dt_side");
        this.field_149936_O = p_149651_1_.registerIcon(this.isOn ? RefStrings.MODID + ":dt_front_on" : RefStrings.MODID + ":dt_front_off");
        this.field_149935_N = p_149651_1_.registerIcon(RefStrings.MODID + ":dt_top");
    }
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata) {
		...
		if (!keepInventory) 
		{
			DTTileEntity tileentity = (DTTileEntity) world.getTileEntity(x, y, z);
	...
	public void onBlockPlacedBy(World world, int xCord, int yCord, int zCord, EntityLivingBase placer, ItemStack stack) {
		...
		if (stack.hasDisplayName()) {
	        ((DTTileEntity) world.getTileEntity(xCord, yCord, zCord)).setCustomName(stack.getDisplayName());
	    }
	...
	public boolean onBlockActivated(World world, int xCord, int yCord, int zCord, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
		if (!world.isRemote) {
	        ...
	        DTTileEntity tileentity = (DTTileEntity)world.getTileEntity(xCord, yCord, zCord);
	    ...
	    FMLNetworkHandler.openGui(player, "greengrow", GUIHandler.DT_TILE_ENTITY, world, xCord, yCord, zCord); //DT_TILE_ENTITY represents '2'
	    return true;
	}
    ...
    {
    	DTTileEntity pbt = new DTTileEntity();
